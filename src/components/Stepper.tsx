...
// [UI COMPONENT] StepContentWrapper - Renders the StepContentWrapper view
...
// [UI COMPONENT] SlideTransition - Renders the SlideTransition view
...
// [UI COMPONENT] Step - Renders the Step view
export function Step({ children }: any) {
  return <div className="step-default">{children}</div>;
}

// [UI COMPONENT] StepIndicator - Renders the StepIndicator view
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: any) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#E6DFD5', color: '#7A7369' },
          active: { scale: 1, backgroundColor: '#E2B87C', color: '#ffffff' },
          complete: { scale: 1, backgroundColor: '#E2B87C', color: '#ffffff' }
        }}
...
// [UI COMPONENT] StepConnector - Renders the StepConnector view
function StepConnector({ isComplete }: any) {
  const lineVariants = {
    incomplete: { width: 0, backgroundColor: 'transparent' },
    complete: { width: '100%', backgroundColor: '#E2B87C' }
  };
...
// [UI COMPONENT] CheckIcon - Renders the CheckIcon view
